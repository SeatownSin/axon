...
//!
//! ```rust,no_run
//! use axon_sandbox::{SandboxManager, ProfileName};
//! use std::path::Path;
//!
...
const BWRAP_ENV_VAR: &str = "__AXON_INSIDE_BWRAP";
...
mod tests {
    ...
    /// Create a temp workspace whose `.axon/sandbox.toml` contains `toml_body`.
