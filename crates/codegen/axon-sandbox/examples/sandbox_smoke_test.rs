...
//! cargo run -p axon-sandbox --example sandbox_smoke_test
//!
//! # Test strict profile
//! cargo run -p axon-sandbox --example sandbox_smoke_test -- strict
//!
...
fn main() {
    ...
    let tmp_test = Path::new("/tmp/.axon-sandbox-test");
