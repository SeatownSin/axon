...
/// [`AuthIdentity`](axon_computer_hub_sdk::AuthIdentity). The two types carry the
...
impl From<axon_computer_hub_sdk::AuthIdentity> for WorkspaceIdentity {
    fn from(id: axon_computer_hub_sdk::AuthIdentity) -> Self {
...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `axon-workspace` crate that produced the record.
    ...
    /// Sandbox profile name (`$AXON_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("AXON_SANDBOX_PROFILE").ok(),
            axon_sandbox::is_inside_bwrap(),
