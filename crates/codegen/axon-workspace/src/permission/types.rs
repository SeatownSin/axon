...
impl From<&axon_tools::types::ToolInput> for AccessKind {
    fn from(input: &axon_tools::types::ToolInput) -> Self {
...
pub enum RequirementSource {
    Unknown,
    /// User-writable `~/.axon/requirements.toml` — untrusted for keeping a
...
mod tests {
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use axon_tools::implementations::use_tool::UseToolInput;
        use axon_tools::types::ToolInput;
