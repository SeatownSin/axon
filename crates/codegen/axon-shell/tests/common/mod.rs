//! Shared helpers for axon-shell integration tests.

use axon_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `axon_sampler::SamplingClient`, which takes a
