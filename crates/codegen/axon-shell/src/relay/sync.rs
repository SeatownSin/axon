...
mod tests {
    ...
    fn test_build_share_url_default() {
        ...
        assert_eq!(url, "https://blocked.invalid/build/test-session-123");
    }
    ...
    fn test_build_share_url_with_uuid() {
        ...
        assert_eq!(
            url,
            "https://blocked.invalid/build/01937d8a-1234-7abc-9def-0123456789ab"
        );
    }
