...
pub enum SessionCommand {
    ...
    SetSessionModel {
        sampling_config: axon_sampler::SamplerConfig,
        use_concise: bool,
    ...
    GetModelMetadata {
        responds_to: oneshot::Sender<axon_chat_state::ModelMetadata>,
    },
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<axon_agent::plugins::PluginRegistry>>,
    },
    /// Re-discover the session's own project hooks (`.axon/hooks`,
    ...
    RepairHistory {
        dry_run: bool,
        respond_to:
            oneshot::Sender<anyhow::Result<axon_chat_state::compaction_utils::HistoryRepairReport>>,
    },
    GetRewindPoints {
    ...
    RecordSubagentUsage {
        by_model: Vec<(String, axon_chat_state::UsageTotals)>,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<axon_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<axon_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<axon_tools::types::TaskSnapshot>>>,
    },
    ...
    GetHooksList {
        respond_to: oneshot::Sender<axon_hooks_plugins_types::HooksListResponse>,
    },
    ...
    TakeTurnMessages {
        respond_to: oneshot::Sender<Option<axon_chat_state::TurnCapture>>,
    },
