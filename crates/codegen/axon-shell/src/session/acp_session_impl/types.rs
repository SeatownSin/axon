...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<axon_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(axon_tools::implementations::axon_build::update_goal::UpdateGoalInput),
    Channel(axon_tools::implementations::axon_build::update_goal::UpdateGoalEnvelope),
}
