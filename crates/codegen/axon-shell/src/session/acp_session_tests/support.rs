...
#[cfg(test)]
pub(crate) fn noop_observability_bridge() -> axon_computer_hub_sdk::ObservabilityBridge {
    axon_computer_hub_sdk::ObservabilityBridge::new(
        None,
        axon_tool_protocol::SessionId::new("test").expect("valid"),
    )
}
#[cfg(test)]
pub(crate) async fn test_agent_default() -> axon_agent::Agent {
...
pub(crate) async fn test_agent_with_tools(
    tools: Vec<axon_tools::registry::types::ToolConfig>,
) -> axon_agent::Agent {
    test_agent_from_config(
        axon_tools::registry::types::ToolServerConfig {
            tools,
...
async fn test_agent_from_config(
    ...
    definition: axon_agent::AgentDefinition,
    backend: std::sync::Arc<dyn axon_tools::computer::types::TerminalBackend>,
) -> axon_agent::Agent {
    use axon_tools::computer::local::LocalFs;
    use axon_tools::computer::types::AsyncFileSystem;
    ...
    axon_agent::Agent::new(
        definition,
        axon_agent::PromptContext::default(),
        String::new(),
        tool_bridge,
        axon_agent::ReminderPolicy::default(),
        axon_agent::CompactionPolicy::default(),
        vec![],
        false,
    )
}
...
pub(crate) async fn create_test_actor_ex(
    ...
    gateway_tx: tokio::sync::mpsc::UnboundedSender<axon_acp_lib::AcpClientMessage>,
    ...
    tool_context.task_completion_reservations =
        Some(axon_tools::reminders::task_completion::TaskCompletionReservations::default());
    tool_context.task_wake_suppressed =
        Some(axon_tools::reminders::task_completion::TaskWakeSuppressed::default());
    ...
    let actor = SessionActor {
        ...
        permissions: axon_workspace::permission::PermissionHandle::allow_all(),
        tool_context,
