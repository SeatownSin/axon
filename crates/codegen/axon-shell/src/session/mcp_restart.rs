...
//! window containing a [`axon_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`axon_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`axon_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`axon_mcp::servers::ClientStateKind::Empty`]
...
use axon_mcp::servers::{McpClientEventKind, McpServerName};
...
pub trait RestartActions {
    ...
    /// Push an already-built `axon/mcp/server_status` payload to the
...
/// ACP `axon/mcp/server_status` notification. Failures are logged and
