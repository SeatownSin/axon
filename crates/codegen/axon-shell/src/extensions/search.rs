...
use axon_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use axon_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "axon/search/content" => {
            ...
            // `axon/search/content/status` batches through the client sink.
