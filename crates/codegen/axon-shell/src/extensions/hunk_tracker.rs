...
//!
//! Provides access to the axon-hunk-tracker functionality for tracking file changes
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "axon/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
