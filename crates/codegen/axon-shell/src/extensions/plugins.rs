...
pub fn loaded_plugin_to_info(plugin: &axon_agent::plugins::LoadedPlugin) -> PluginInfo {
    use axon_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &axon_agent::plugins::PluginOrigin) -> PluginOrigin {
...
mod tests {
    use super::*;
    use axon_agent::plugins::PluginOrigin as AgentOrigin;
    use axon_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> axon_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        axon_agent::plugins::LoadedPlugin {
