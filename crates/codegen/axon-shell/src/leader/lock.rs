...
/// `~/.axon/leader.sock` — e.g. run a local branch build's leader without
...
/// bypassed entirely.
pub const LEADER_SOCKET_ENV: &str = "AXON_LEADER_SOCKET";
...
mod tests {
    ...
    fn override_socket_path_wins_over_ws_url_derivation() {
        let root = Path::new("/home/u/.axon");
        let override_sock = PathBuf::from("/home/u/.axon/leader-branch.sock");
        ...
        assert_eq!(
            ...
            PathBuf::from("/home/u/.axon/leader-branch.lock")
        );
    }
