...
//! axon-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use axon_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use axon_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn axon_tools::implementations::lsp::LspBackend>>,
    ...
    pub task_wake_suppressed: Option<axon_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = axon_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
