...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(axon_workspace::file_system::LocalFs::new(PathBuf::from(
            "/tmp",
        ))),
        ...
        parent_skills: None,
        parent_skills_config: axon_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: axon_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: axon_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl axon_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &axon_tools::implementations::lsp::LspToolInput,
    ) -> axon_tools::implementations::lsp::LspToolResult {
        axon_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<axon_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<axon_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
