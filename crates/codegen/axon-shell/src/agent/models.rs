...
struct Inner {
    ...
    gateway: RwLock<Option<axon_acp_lib::AcpAgentGatewaySender>>,
...
impl ModelsManager {
    ...
    pub(crate) fn set_gateway(&self, gateway: axon_acp_lib::AcpAgentGatewaySender) {
    ...
    /// Hot-reload the catalog from `~/.axon/models_cache.json` after an
