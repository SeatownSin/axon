...
impl MemoryModalState {
    ...
    #[cfg(test)]
    fn query_viewport(&self, width: usize) -> axon_ratatui_textarea::SingleLineViewport {
...
pub fn build_entries(
    files: Vec<axon_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(file_label("/home/user/.axon/memory/MEMORY.md"), "MEMORY.md");
        assert_eq!(
            file_label("/workspace/.axon/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use axon_shell::extensions::notification::MemoryFileInfo;
