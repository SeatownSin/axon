...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `axon/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. AxonNight's dark band leaking into AxonDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default AxonNight, dark) after the user switches —
        // painting a dark band on a light AxonDay canvas.
...
mod tests {
    ...
    fn yank_selected_multiline_copies_full_text() {
        ...
        use axon_ratatui_textarea::ClipboardProvider;
