...
//! `/docs web` opens https://docs.blocked.invalid/build/overview in the browser.
...
/// Online Build docs landing page (hardcoded like other TUI deep-links; docs.blocked.invalid can redirect if the path moves).
pub const BUILD_DOCS_URL: &str = "https://docs.blocked.invalid/build/overview";
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open docs.blocked.invalid/build in the browser".into(),
            },
        ];
