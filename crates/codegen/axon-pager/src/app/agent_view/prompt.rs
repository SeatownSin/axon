                ...
                if self.prompt.accept_prompt_suggestion() {
                    ...
                    axon_telemetry::session_ctx::log_event(
                        axon_telemetry::events::PromptSuggestion {
                            action: axon_telemetry::events::PromptSuggestionAction::Accepted,
                            chars,
                            words,
                        },
                    );
            ...
            match self.prompt.handle_key(key) {
                PromptEvent::Edited => {
                    if undo_tip_accepted {
                        axon_telemetry::session_ctx::log_event(
                            axon_telemetry::events::ContextualTip {
...
mod prompt_suggestion_key_tests {
    ...
    /// right after a turn ends with `axon/suggestPrompt` resolved. Pins the
