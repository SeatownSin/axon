...
fn cta_entry(name: &str, status: &str) -> axon_hooks_plugins_types::MarketplacePluginEntry {
        ...
        vec![
            acp::PermissionOption::new(
                acp::PermissionOptionId::new(Arc::from(
                    axon_workspace::permission::ENABLE_ALWAYS_APPROVE_OPTION_ID,
                )),
...
fn push_synthetic_permission(
    ...
    let request = axon_acp_lib::AcpArgs {
