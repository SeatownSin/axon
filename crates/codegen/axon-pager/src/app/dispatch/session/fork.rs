...
-> [axon_tools::implementations::axon_build::ask_user_question::QuestionOption; 2] {
    use axon_tools::implementations::axon_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// [`Effect::ForkSession`] which calls `axon/session/fork` directly.
