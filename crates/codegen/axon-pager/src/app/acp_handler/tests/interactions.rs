#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn ask_user_question_routes_to_background_session_not_active_view() {
        ...
        .unwrap();
        let msg = AcpClientMessage::ExtMethod(axon_acp_lib::AcpArgs {
            request: acp::ExtRequest::new("axon/ask_user_question", raw.into()),
            response_tx: tx,
        });
    ...
    fn close_viewer_preserves_plan_approval_state() {
        ...
        handle(
            AcpClientMessage::ExtMethod(axon_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("axon/exit_plan_mode", raw.into()),
                response_tx: tx,
            }),
            &mut app,
        );
