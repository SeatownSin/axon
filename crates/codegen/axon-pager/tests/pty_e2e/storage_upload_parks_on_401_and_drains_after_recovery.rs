...
async fn storage_upload_parks_on_401_and_drains_after_recovery() {
    ...
    env_refs.retain(|(k, _)| *k != "AXON_TRACE_UPLOAD");
    env_refs.push(("AXON_TRACE_UPLOAD", "true"));
    env_refs.push(("AXON_TELEMETRY_TRACE_UPLOAD", "true"));
    env_refs.push(("AXON_UPLOAD_QUEUE_AUTH_PROBE_SECS", "2"));
    ...
    //
    // Accounting (axon-file-utils upload queue):
    ...
    //   not fire inside this 3s window; with `AXON_UPLOAD_QUEUE_AUTH_PROBE_SECS=2`
