...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "axon-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "axon-3", "researcher");
    ...
    let shared_models = ["axon-3", "axon-3-mini"];
