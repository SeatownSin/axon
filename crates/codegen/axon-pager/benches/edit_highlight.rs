...
//!
//! ```text
//! cargo bench -p axon-pager --bench edit_highlight
//! cargo bench -p axon-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use axon_pager::diff::{DiffHunk, DiffLine};
use axon_pager::scrollback::blocks::tool::{
...
use axon_pager::syntax::{Syntect, get_syntect};
