...
| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `axon -p`, output formats, CI/CD integration, and piping |
...
| 24 | [Monitoring Usage](24-monitoring-usage.md) | Why nothing is sent anywhere, what you can still see locally, and recording per-session and per-subagent usage from a hook |
