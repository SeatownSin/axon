...
use crate::implementations::axon_build::bash::{
...
impl axon_tool_runtime::Tool for BashConciseTool {
    ...
    async fn run(
        ...
        let result = axon_tool_runtime::Tool::run(&BashTool, ctx, input).await?;
...
mod tests {
    ...
    fn no_double_header_after_default_prebake() {
        ...
        bash.output_for_prompt =
            crate::implementations::axon_build::bash::format_default_prompt(&bash);
