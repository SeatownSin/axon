...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::AxonBuildConcise
    }
...
impl axon_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // AxonBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::axon_build::read_file::ReadFileTool;
