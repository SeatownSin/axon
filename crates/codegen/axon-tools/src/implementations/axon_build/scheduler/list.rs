...
impl axon_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl axon_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> axon_tool_protocol::ToolId {
        axon_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, axon_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                axon_tool_runtime::ToolError::execution(
                    axon_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
