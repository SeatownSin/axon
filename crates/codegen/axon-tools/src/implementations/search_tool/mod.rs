...
impl axon_tool_runtime::Tool for SearchTool {
    type Args = SearchToolInput;
    type Output = ToolOutput;

    fn id(&self) -> axon_tool_protocol::ToolId {
        axon_tool_protocol::ToolId::new("search_tool").expect("valid tool id")
    }
...
mod tests {
    ...
    fn hash_value_pinned_output() {
        ...
        let h = hash_value(&"axon-mcp-fingerprint-stability-test");
        assert_eq!(h, hash_value(&"axon-mcp-fingerprint-stability-test"));
