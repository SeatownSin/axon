...
//!
//! Reuses the core file-reading logic from [`axon_build::read_file::run_read_file`]
...
use crate::implementations::axon_build::read_file::{ReadFileInput, run_read_file};
...
impl axon_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> axon_tool_protocol::ToolId {
        axon_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::axon_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    fn tool_metadata() {
        ...
        assert_eq!(axon_tool_runtime::Tool::id(&tool).as_str(), "hashline_read");
    ...
    /// file content independently of axon_build `read_file`).
    #[tokio::test]
