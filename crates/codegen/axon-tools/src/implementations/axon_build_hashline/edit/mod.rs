...
impl crate::types::tool_metadata::ToolMetadata for HashlineEditTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::AxonBuildHashline
    }
...
impl axon_tool_runtime::Tool for HashlineEditTool {
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, axon_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<axon_tool_runtime::Cwd>() {
            ...
            let scheme = params
                .0
                .build_scheme()
                .map_err(axon_tool_runtime::ToolError::invalid_arguments)?;
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::axon_build_hashline::anchor::split_lines;
        use crate::implementations::axon_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::axon_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    async fn output_is_tool_output_search_replace() {
        ...
        let result: crate::types::output::SearchReplaceOutput =
            axon_tool_runtime::Tool::run(&tool, test_ctx(resources.into_shared()), input)
                .await
                .unwrap();
    ...
    fn test_scheme() -> Box<dyn crate::implementations::axon_build_hashline::scheme::AnchorScheme> {
        crate::implementations::axon_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
