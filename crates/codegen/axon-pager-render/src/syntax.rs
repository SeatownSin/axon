...
//! Dark themes (AxonNight, TokyoNight) share `axon-night.tmTheme`;
//! AxonDay uses `axon-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use axon_markdown::Syntect;

use crate::theme::ThemeKind;

static SYNTECT_AXONNIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_TOKYONIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_AXONDAY: OnceLock<Syntect> = OnceLock::new();
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_AXONNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/axon-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::AxonDay => SYNTECT_AXONDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/axon-day.tmTheme"))),
    }
}
