...
//!
//! In dev mode, watches ~/.axon/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.axon/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.axon/pager.toml, watches for changes
