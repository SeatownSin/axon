...
use axon_pager::appearance::AppearanceConfig;
use axon_pager::minimal_api;
use axon_pager::render::Renderable;
use axon_pager::scrollback::block::RenderBlock;
use axon_pager::scrollback::blocks::ToolCallBlock;
use axon_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                axon_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
