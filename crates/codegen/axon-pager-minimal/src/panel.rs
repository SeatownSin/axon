...
use axon_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use axon_pager::views::modal::ActiveModal;
use axon_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use axon_pager::views::extensions_modal::ExtensionsModalState;
    use axon_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    use ratatui::layout::Rect;
    ...
    fn session_entry(id: &str) -> axon_pager::app::app_view::SessionPickerEntry {
        axon_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<axon_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: axon_pager::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: axon_pager::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a
