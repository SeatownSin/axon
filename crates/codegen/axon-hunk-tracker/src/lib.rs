//! axon-hunk-tracker - Track file hunks (diffs) with agent/external attribution.
//!
//! This crate provides:
//! - Actor-based hunk tracking with source attribution (Agent vs External)
//! - Integration with axon-shell sessions
//!
//! ## Actor Pattern
//!
...
//!
//! ```rust,ignore
//! use axon_hunk_tracker::{HunkTrackerActor, HunkEvent, TrackingMode, HunkAction};
//! use tokio::sync::mpsc;
//!
