...
impl TraceUploadReason {
    ...
    pub fn from_upload_method(method: &Option<axon_file_utils::UploadMethod>) -> Self {
        match method {
            Some(axon_file_utils::UploadMethod::Proxy { .. }) => Self::Proxy,
            Some(axon_file_utils::UploadMethod::S3 { .. }) => Self::DirectS3,
            Some(axon_file_utils::UploadMethod::Direct { .. }) => Self::DirectGcs,
...
#[cfg(test)]
mod tests {
    use axon_file_utils::UploadMethod;
