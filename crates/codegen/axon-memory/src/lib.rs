...
//! Axon to persist important information across sessions. Memory files are
//! stored under `~/.axon/memory/` with workspace-scoped subdirectories
...
//! `AXON_MEMORY=1` environment variable. When disabled, this crate
