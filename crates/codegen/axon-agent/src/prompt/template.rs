...
/// The base prompt template source, exposed for `axon prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `axon prompt --section apply-patch-template`.
