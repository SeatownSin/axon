...
/// `filename`, `path`, `metadata`) that the Axon SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Axon SLOP converter to
    ...
    /// - `path`: file path on the Axon Computer filesystem
