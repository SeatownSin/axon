...
//! string/text manipulation. Harness-bound extraction (Axon chat's
//! `AxonConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `AxonMessage` assembly) stays in the harness crate.
