...
pub struct BeforeTurnPayload {
    ...
    pub turn_number: u64,
    /// Model being used for this turn (e.g. "axon-3").
    pub model_id: String,
    ...
    /// (`"primary"` | `"subagent"`). A `String`, not the `axon-file-utils`
...
pub struct AfterTurnPayload {
    ...
    /// the workspace decodes it into the `axon-file-utils`
